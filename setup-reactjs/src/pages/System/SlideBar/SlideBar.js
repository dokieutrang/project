...
function Sidebar(props) {
  ...
  menuItems.push(
    ...
    //organizer
    { to: "/quantitly-metting", label: "Meeting", icon: "fa-calendar", roles: ["organizer"] },
    { to: "/request", label: "Request", icon: "fa-calendar-check-o", roles: ["organizer"] },
  );
    ...
    <>
      <div className={`sidebar ${isSidebarOpen ? "open" : "open"}`}>
        <div className="logo-details">
          <div className="logo_name">Organize events</div>
